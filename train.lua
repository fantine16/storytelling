...
cmd:option('-max_epoch', 20, 'max number of epoch to run for (-1 = run forever)')
...
while true do	
	...
	if opt.max_epoch > 0 and iter*opt.batch_size/num_train >= opt.max_epoch then end -- stopping criterion
